...
const RelatedDocters = ({docId,speciality}) => {
  ...
  return (
    ...
    <button onClick={()=>{navigate("/doctors");scrollTo(0,0)}} className='bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 hover:bg-primary hover:text-white hover:scale-105 hover:translate-y-[-10px] transition-all duration-500'>more</button>
</div>
  )
}
